...
d3.csv("https://raw.githubusercontent.com/ripleycleghorn/thesis/main/project-code/all_emissions.csv").then(data =>{
    ...
    var filteredArray = data.filter(d => d.numericYear > 2010)
    ...
    var xScale = d3.scaleTime()
        .domain(d3.extent(filteredArray, d => d.year))
        .range([0, width]);
    var yScale = d3.scaleLinear()
        .domain([d3.min(filteredArray, d => d.emissions), d3.max(filteredArray, d => d.emissions) + 4])
        .range([height, 0]);
